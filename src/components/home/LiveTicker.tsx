...
const LiveTicker = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] h-8 border-b border-border/40 bg-black/95 backdrop-blur-md overflow-hidden">
      <div className="flex items-center h-full">
        <div className="flex-shrink-0 flex items-center justify-center gap-1 w-[52px] h-8 bg-primary text-primary-foreground font-bold text-[10px] uppercase">
