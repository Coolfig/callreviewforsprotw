...
const FEATURES = [
  ...
  { icon: <Users className="w-4 h-4" />, title: "Linked to reviews", desc: "Related controversial calls from the Under Review feed are cross-referenced on every year page." },
];
